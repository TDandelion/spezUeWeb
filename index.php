        ...
        <div class="container">
            <div class="menu">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2 rightSide">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="row mainMenu">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-4 rounded-button">
                                <button class="btn btn-default"><i class="glyphicon glyphicon-cog glyphiconMenu"></i><br />Fenster</button>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-offset-7 col-md-2">
                    <button class="btn btn-default btn-lg allBtnOn">Änderungen speichern</button>
                </div>
            </div>
